        ...
        <Dropdown
          menu={{
            items: statusOptions.map(option => ({
              key: option.key,
              label: option.label,
              disabled: record.status === option.key,
              onClick: () => updateTaskStatus(record._id, option.key)
            }))
          }}
        >
          <Button size="small" disabled={record.status === 'Completed'}>
            <Space>
              {record.status === 'Completed' ? ' Already Completed' : 'Update Status'}
              <DownOutlined />
            </Space>
          </Button>
        </Dropdown>
